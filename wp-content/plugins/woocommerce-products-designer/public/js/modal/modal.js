...
+function ($) {
  ...
  Modal.prototype.show = function (_relatedTarget) {
    ...
    this.$element.on('click.dismiss.orion.omodal', '[data-dismiss="omodal"]', $.proxy(this.hide, this))
    ...
    this.backdrop(function () {
      ...
      transition ?
        that.$element.find('.omodal-dialog') // wait for modal to slide in
  ...
  $(document)
    .on('show.orion.modal', '.omodal', function () { $(document.body).addClass('modal-open') })
    .on('hidden.orion.modal', '.omodal', function () { $(document.body).removeClass('modal-open') })
